...
### Data Sources
The data is taken from a LimeSurvey exported .csv file consisting of answers from 695 respondents and both open-ended and forced-choice items with a combination of quantitative and qualitative data: 
